    ...
    <div class="container-fluid">
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <th scope="col" style="width:4%"><center>Contact Person</center></th>
            ...
            @foreach($actual_biddings as $actual_bidding)
                ...
                <tr>
                    ...
                    <td data-toggle="tooltip" title="Items!"><center><select  @php if($actual_bidding->submitted) echo "disabled" @endphp id="status-{{$actual_bidding->id}}"><option disabled selected>Select...</option><option @php if($actual_bidding->status== "Qualified") echo "selected" @endphp value="Qualified">Qualified</option><option @php if($actual_bidding->status== "Not Qualified") echo "selected" @endphp value="Not Qualified">Not Qualified</option></select></center></td>
                    <td data-toggle="tooltip" title="Items!"><center><select @php if($actual_bidding->submitted) echo "disabled" @endphp  id="notice-{{$actual_bidding->id}}"><option disabled selected>Select...</option><option @php if($actual_bidding->notice== "Goods") echo "selected" @endphp value="Goods">Goods</option><option @php if($actual_bidding->notice== "Infrastructure") echo "selected" @endphp value="Infrastructure">Infrastructure</option></select></center></td>
